...
describe SiteMapper do
   ...
   describe "Module option" do
      ...
      describe "when asked about the attributes" do
         ...
         it "should have the extra collection with the right value" do
            SitemapperTestAR.sitemap[:extra].must_be_nil
         end

         it "should read and write on attributes" do
            str = "yearly"
            SitemapperTestAR.sitemap[:changefreq] = str
            SitemapperTestAR.sitemap[:changefreq].must_equal str
         end
      end
   end
end
